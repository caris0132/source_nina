<?php
    ...
    $d->reset();
    $d->query("select ten_$lang as ten,id,tenkhongdau,thumb,mota_$lang as mota from #_baiviet where type='chinhsach' and noibat=1 and hienthi=1 order by stt,id desc limit 6");
