...
// link tương đối
$ckeditor_url=$_SESSION['ckeditor_url'] . '/upload/';
$baseUrl = $page_http . $ckeditor_url;
$baseUrlAbsolute = "//" .  $ckeditor_url;

// đường dẫn đến thư mục source
$baseRoot = $_SERVER['DOCUMENT_ROOT'];
$baseRoot .= substr($_SESSION['ckeditor_url'], strlen($_SERVER['SERVER_NAME']));
$baseRoot .= '/upload/';
...
// get ckfinder keygen . https://www.phamgiang.pro/apps/ckfinderKey .
$config['licenseName'] = $_SERVER['SERVER_NAME'];
if ($_SERVER['SERVER_NAME'] == 'localhost') {
    $config['licenseKey']  = 'XHDH91X6HGHWWJB291614Y29EPBHF';
}
else {
    $config['licenseKey']  = 'XHDH91X6HGHWWJB291614Y29EPBHF';
}
...
$config['backends'][] = array(
    'name'         => 'ndt_custom',
    'adapter'      => 'local',
    'baseUrl'      => $baseUrlAbsolute,
    'root'         => $baseRoot, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
    'filesystemEncoding' => 'UTF-8',
);
