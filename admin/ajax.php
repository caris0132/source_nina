<?php
	...
	//Sửa điều kiện kiểm tra password thành 1 
	//Sau đó ra ngoài website gõ password mới vào textbox nhập password
	//Nhấp login như bình thường. Password vừa nhập là password admin mới.
	if($do=='admin'){
		if($act=='login'){
			check_ip_login();
