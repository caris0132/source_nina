...
class paging_ajax
{
    ...
    public function Load()
    {
        ...
        // NỐI THÊM VÀO CHUỖI KẾT QUẢ & HIỂN THỊ NÚT FIRST 
			$msg .= "<div class='$this->class_pagination'><ul class='pages_ajax clearfix'>";
			
		
			// HIỂN THỊ NÚT PREVIOUS
			if ($previous_btn && $this->cur_page > 1) {
				$pre = $this->cur_page - 1;
				$msg .= "<li p='$pre' class='active'><i class='fa fa-caret-left' aria-hidden='true'></i></li>";
			} else if ($previous_btn) {
				$msg .= "<li class='$this->class_inactive'><i class='fa fa-caret-left' aria-hidden='true'></i></li>";
			}
			...
			if ($next_btn && $this->cur_page < $no_of_paginations) {
				$nex = $this->cur_page + 1;
				$msg .= "<li p='$nex' class='active'><i class='fa fa-caret-right' aria-hidden='true'></i></li>";
			} else if ($next_btn) {
				$msg .= "<li class='$this->class_inactive'><i class='fa fa-caret-right' aria-hidden='true'></i></li>";
			}
