        ...
        if($tintuc){
            ...
            <div class="col_news col-md-3 col-sm-6 col-xs-6">
                <div class="box_news clearfix">
                    <a class="box_news_img" href="<?=$value['tenkhongdau']?>" title="<?=$value['ten_'.$lang]?>" class="my_glass"><img alt="<?=$value['ten_'.$lang]?>" src="thumb/300x250/1/<?=_upload_baiviet_l.$value['photo']?>" onError="noImg(this, 300, 250)" class="w100 trans03"/></a>
